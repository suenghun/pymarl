...
class Agent:
    def __init__(self,
        ...
        self.node_representation = NodeRepresentation(feature_size = feature_size, hidden_size = hidden_size_obs, n_representation_obs = n_representation_obs).to(device) # 수정사항
        self.action_representation = NodeRepresentation(feature_size = feature_size + 6, hidden_size = hidden_size_obs, n_representation_obs = n_representation_obs).to(device) # 수정사항
