...
class Agent:
    def __init__(self,
        ...
        self.node_representation = NodeEmbedding(feature_size = feature_size-1, hidden_size = hidden_size_obs, n_representation_obs = n_representation_obs).to(device) # 수정사항
        self.action_representation = NodeEmbedding(feature_size = feature_size + 6-1, hidden_size = hidden_size_obs, n_representation_obs = n_representation_obs).to(device) # 수정사항
