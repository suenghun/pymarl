...
class Replay_Buffer_for_RNN:
    ...
    def memory(self, obs, action, reward, avail_actions, done, padding,  last_action):
        ...
        self.buffer[-1][1].append(action)
        self.buffer[-1][2].append(reward)
        self.buffer[-1][3].append(avail_actions)
        self.buffer[-1][4].append(done)
        self.buffer[-1][5].append(padding)
    ...
    def sample(self, episode):
        ...
        return obses, actions, rewards, avail_actions, dones, paddedes
...
class Agent:
    ...
    def learn(self, episode, variance = False, regularizer = 1):
        ...
        obses,actions, rewards, avail_actions, dones, paddings = self.buffer.sample(episode)
        ...
        del obses, actions, rewards, avail_actions
    ...
    def memory(self, obs,  action, reward, avail_actions, done, padding,last_action):
        self.buffer.memory(obs, action, reward, avail_actions, done, padding, last_action)
