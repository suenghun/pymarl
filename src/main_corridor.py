...
def main():
    try:
        ...
        env = StarCraft2Env(map_name=map_name, step_mul=8, replay_dir="Replays",seed = 123)
        ...
        for e in range(n_episodes):
            ...
            while (not done) and (step < max_episode_len):
                ...
                agent.memory(obs, action, reward, avail_action, done, padding,
                             last_action)
            ...
            if eval == True:
                ...
                for _ in range(eval_num):
                    ...
                    if win_tag == True:
                        win_rate += 1 / 32 * 100
                        if record == True:
                            #env.replay_prefix = "episode : {},{}".format(e, s)
                            env.save_replay()
                            record = False
